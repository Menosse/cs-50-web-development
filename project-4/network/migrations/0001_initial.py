    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('following_list', models.ManyToManyField(blank=True, null=True, related_name='following_list', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Follower',
            fields=[
                ...
                ('follower_list', models.ManyToManyField(blank=True, null=True, related_name='follower_list', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
